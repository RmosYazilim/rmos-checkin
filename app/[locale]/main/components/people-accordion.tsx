          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
              ...
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <MedeniSelect value={field.value} onChange={field.onChange} />
                )}
              />
              <Controller
                name="Allerjankodu"
              ...
              <div className=" flex flex-col mt-2 items-center justify-start">
                ...
                <div className="w-full mt-1 h-full flex ">
                  <Controller
                    name="imza"
                    control={control}
                    render={({ field }) => (
                      <SignatureCanvas
                        ...
                        canvasProps={{
                          className:
                            'sigCanvas mb-3 border border-gray-300 rounded-lg max-h-[100px] w-full h-full h-auto',
                        }}
                      />
                    )}
                  />
