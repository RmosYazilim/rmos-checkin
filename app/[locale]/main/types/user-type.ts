...
export const createUserSchema = (t: TranslationFunction) => {
  return z.object({
    ...
    Adi: z.string().min(3, t('validation.min')),
    Soyadi: z.string().min(3, t('validation.min')),
    Ulke: z.string(),
    Online_10: z.number(),
    Anaadi: z.string().min(3, t('validation.min')),
    Babaadi: z.string().min(3, t('validation.min')),
    Kimlikid: z.number(),
    ...
    Tcno: z.string().min(3, t('validation.min')),
